...
[`.github/instructions/`](.github/instructions/), with focused guidance for Astro,
the Drizzle/SQLite data layer, styling, UI components, and tests. In particular:

- Comments explain **why** a decision exists, not what the following code already says.
...
- TypeScript uses single quotes, semicolons, trailing commas in multiline
  structures, four-space indentation, and interface-based object contracts; ESLint
  enforces the interface convention.
